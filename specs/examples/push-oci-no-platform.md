...
## Push
```
./bin/artifact-cli push localhost:5001/educates/my-app-oci:1.0.0 -f ./test/my-app --as oci
```

## Verify

```
crane manifest localhost:5001/educates/my-app-oci:1.0.0 | jq
```
  ...
  "manifests": [
    {
      ...
      "digest": "sha256:dc8b63c63178bca5f0870a8a8293c47edb6087cbcd84e6bcbcb822a9a9e2b7b7",
      "size": 743,
      "platform": {
        "architecture": "amd64",
        "os": "linux"
